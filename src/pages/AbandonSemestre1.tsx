...
interface AbandonSemestre1Props {
  classeName: string;
  onBack: () => void;
}

export const AbandonSemestre1: React.FC<AbandonSemestre1Props> = ({ classeName, onBack }) => {
  ...
  const handleSave = () => {
    ...
    alert(`${abandonedCount} élève(s) marqué(s) comme ayant abandonné au 1er semestre`);
    setHasChanges(false);
  };
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">
            Définition des abandons du premier semestre de la{' '}
            <span className="text-red-600">{classeName}</span>
          </h2>
        </div>

        <div className="bg-gradient-to-r from-red-100 to-rose-100 rounded-xl shadow-lg p-6 border-2 border-red-200">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                <strong>NB:</strong> Cochez devant tous les élèves qui ont abandonné au premier semestre.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-red-200">
          <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-red-100 to-rose-200 rounded-lg flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden border-2 border-red-200">
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <button
                        ...
                        className={`relative inline-flex h-8 w-16 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ${
                          student.isAbandoned ? 'bg-red-600' : 'bg-gray-300'
                        }`}
                      >
                        <span
        ...
        <div className="flex justify-center">
          <button
            ...
            className={`flex items-center gap-3 px-8 py-4 rounded-xl font-bold text-lg shadow-2xl transition-all duration-200 ${
              hasChanges
                ? 'bg-gradient-to-r from-red-500 to-rose-600 text-white hover:from-red-600 hover:to-rose-700 hover:shadow-red-500/50'
