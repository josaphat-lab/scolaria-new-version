...
interface MoyennesSemestre1Props {
  classeName: string;
  onBack: () => void;
}

export const MoyennesSemestre1: React.FC<MoyennesSemestre1Props> = ({ classeName, onBack }) => {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">
            Moyennes générales du premier semestre de la{' '}
            <span className="text-blue-600">{classeName}</span>
          </h2>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden border-2 border-blue-200">
          <div className="bg-gradient-to-r from-blue-500 to-cyan-600 px-6 py-4">
            <div className="flex items-center gap-3 text-white">
              ...
              <h3 className="text-xl font-bold">Résultats du premier semestre</h3>
            </div>
          </div>
                ...
                {filteredStudents.map((student, index) => (
                  <tr
                    ...
                    className={`transition-colors duration-150 ${
                      index % 2 === 0 ? 'bg-white hover:bg-blue-50' : 'bg-blue-50/50 hover:bg-blue-100'
                    }`}
                  >
